			...
			<div class="container-fluid">
							...
							<div class="breadcrumb_nav">
								<ol class="breadcrumb">
									<li>
										...
										<a class="parent-item" href="page/queryADById.jsp">浏览区</a>
										<i class="fa fa-angle-right"></i>
									<li class="active">按用户浏览</li>
								</ol>
							</div>
						</div>
					</div>
				...
				<section class="chart_section">
					<form action="manager/advertisementServlet" method="post">
						<input type="hidden" name="action" value="queryADByRegister" />
						<%--表单错误回显--%>
						<%--信息提示--%>
						<span style="margin-left: auto">
							${ empty requestScope.msg01?"":requestScope.msg01}
						</span>
						<div  class="col-12 form-group pull-right top_search">
							<div class="input-group" style="width: 90%;margin-right: auto;margin-left: auto;">
								<input type="text" name="id" value="<%=request.getAttribute("id")==null?"":request.getAttribute("id")%>" class="form-control" placeholder="Input User ID And Search...">
