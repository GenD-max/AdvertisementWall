	...
	<div class="container_full">
		...
		<div class="content_wrapper">
			<div class="container-fluid">
							...
							<div class="breadcrumb_nav">
								<ol class="breadcrumb">
									<li>
										...
										<a class="parent-item" href="page/insertAD.jsp">操作区</a>
				...
				<div class="container-fluid">
					<!--上传到服务器的表单-->
					<form action="manager/addADServlet" method="post" enctype="multipart/form-data">
						<%--添加广告信息回显--%>
						<span style="margin-left: auto">
							${ empty requestScope.sucinfo?"建议上传图片尺寸长：宽 = 3：5":requestScope.sucinfo}
						</span>
						<div  class="col-12 form-group pull-right top_search" style="width: 880px">
								<div style="width: 500px;height: 375px;">
										<div class="input-group" style="width: 56%;">
											<input type="text" name="serialNumber" value="" class="form-control" placeholder="输入您要添加的广告序列号...">
											<span style="height: 14px" class="input-group-btn">
												<button  class="btn btn-default" type="submit" >添加</button>
											</span>
										</div><br/>
										<textarea style="width: 280px" name="content" content="" rows="10" cols="40"></textarea><br/>
										<input type="file" style="width: 200px" name="pictureName" value=""
										   accept=".jpg, .jpeg, .png">
