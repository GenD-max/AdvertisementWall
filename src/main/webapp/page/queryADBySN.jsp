...
<head>
	...
	<link href="static/css/style-ad-single.css" rel="stylesheet">
			...
			<div class="container-fluid">
							...
							<div class="breadcrumb_nav">
								<ol class="breadcrumb">
									<li>
										...
										<a class="parent-item" href="page/浏览去-按广告编号查找.jsp">浏览区</a>
										<i class="fa fa-angle-right"></i>
									<li class="active">按广告编号查找</li>
								</ol>
							</div>
						</div>
					</div>
				...
				<section class="chart_section">
					...
					<form action="manager/advertisementServlet" method="post">
						<%--隐藏域--%>
						<input type="hidden" name="action" value="queryOneAD" />
							<%--表单错误回显--%>
							<%--信息提示--%>
							<span style="margin-left: auto">
								${ empty requestScope.msg?"请以用户名+广告编号的方式输入":requestScope.msg}
							</span>
								<div  class="col-12 form-group pull-right top_search">
									<div class="input-group" style="width: 80%;margin-right: auto;margin-left: auto;">
										<input type="text" class="form-control" placeholder="Input AD Serial Number And Search..." name="serialNumber" value="<%=request.getAttribute("serialNumber")==null?"":request.getAttribute("serialNumber")%>">
										<span style="height: 14px" class="input-group-btn">
											<button class="btn btn-default" type="submit">提交</button>
										</span>
									</div>
								</div>
								<main class="page-content" style="max-width: 1250px">
									<card></card>
