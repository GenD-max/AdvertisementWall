				...
				<div class="container-fluid">
							<div  class="col-12 form-group pull-right top_search" style="width: 880px">
								<div style="width: 500px;height: 375px;">
									<!--上传到服务器的表单-->
									<form action="manager/uploadServlet" method="post" enctype="multipart/form-data">
									<%--添加广告信息回显--%>
										<span style="margin-left: auto">
											${ empty requestScope.sucinfo?"":requestScope.sucinfo}
										</span>
										<div class="input-group" style="width: 56%;">
											<input type="text" class="form-control" placeholder="输入您要添加的广告序列号..." name="serialNumber" value="">
											<span style="height: 14px" class="input-group-btn">
												<button  class="btn btn-default" type="submit" >添加</button>
											</span>
										</div><br/>
										<textarea rows="10" cols="40" name="content" style="" >在此输入广告文本...</textarea><br/>
